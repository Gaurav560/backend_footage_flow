...
class VisualTaggingService:
    def __init__(self, project_id):
        ...
        # Set Google Cloud credentials - Support both file and environment variable
        credentials_path = os.path.join(os.path.dirname(__file__), 'google-credentials.json')
        credentials_json = os.environ.get('GOOGLE_APPLICATION_CREDENTIALS_JSON')
        
        # If we have JSON in environment variable, create temporary file
        if credentials_json:
            try:
                import tempfile
                import json
    ...
    def extract_frames_from_video(self, video_path, video_id, fps=1.0, start_time: Union[float, None] = None, end_time: Union[float, None] = None):
        """
    ...
    def tag_video(self, video_path, video_id, start_time: Union[float, None] = None, end_time: Union[float, None] = None):
        """
